...
abstract class FormStyler extends Module {
	...
	public function __construct() {
		/**
		 * Fires before the FormStyler constructor runs.
		 *
		 * Allows executing code before the form styler is initialized.
		 *
		 * @since 3.2.0
		 *
		 * @param FormStyler $this Current FormStyler instance
		 */
		...
		/**
		 * Fires after the FormStyler instance is constructed.
		 *
		 * @since 3.2.0
		 *
		 * @param FormStyler $this Current FormStyler instance
	...
	public function get_advanced_fields_config(): array {
		...
		$advanced_fields['margin_padding'] = Utils::selectors_margin_padding( $this->main_css_element );
		$advanced_fields['max_width']      = Utils::selectors_max_width( $this->main_css_element );
		$advanced_fields['height']         = Utils::selectors_default( $this->main_css_element );
	...
	protected function squad_get_css_selector( string $key ) {
		 ...
		 *
		 * @param string|array|null $value The selector value
		 */
	...
	protected function squad_add_background_field( string $label, string $base_name, string $toggle_slug ): array {
		return $this->squad_utils->add_background_field(
			array(
				'label'       => $label,
				'base_name'   => $base_name,
	...
	protected function squad_get_button_fields( array $fields_after_background, array $fields_before_margin ): array {
		return $this->squad_utils->get_button_fields(
			array(
	...
	protected function squad_add_custom_spacing_field( string $label, string $type, array $settings ): array {
		...
		return Utils::add_margin_padding_field(
			$label,
	...
	protected function squad_add_wrapper_transition_fields( array &$fields ): void {
		...
		Utils::fix_border_transition( $fields, 'wrapper', $this->form_selector );
		Utils::fix_box_shadow_transition( $fields, 'wrapper', $this->form_selector );
	}
	...
	protected function squad_add_field_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'field_text', $this->field_selector );
		Utils::fix_border_transition( $fields, 'field', $this->field_selector );
		Utils::fix_box_shadow_transition( $fields, 'field', $this->field_selector );
	}
	...
	protected function squad_add_error_message_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'message_error_text', $this->error_message_selector );
		Utils::fix_border_transition( $fields, 'message_error', $this->error_message_selector );
		Utils::fix_box_shadow_transition( $fields, 'message_error', $this->error_message_selector );
	}
	...
	protected function squad_add_success_message_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'message_success_text', $this->success_message_selector );
		Utils::fix_border_transition( $fields, 'message_success', $this->success_message_selector );
		Utils::fix_box_shadow_transition( $fields, 'message_success', $this->success_message_selector );
	}
	...
	protected function squad_add_button_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'form_button_text', $this->submit_button_selector );
		Utils::fix_border_transition( $fields, 'form_button', $this->submit_button_selector );
		Utils::fix_box_shadow_transition( $fields, 'form_button', $this->submit_button_selector );
	}
	...
	protected function squad_add_generic_transition_fields( array &$fields ): void {
		Utils::fix_fonts_transition( $fields, 'field_label_text', "$this->form_selector label, $this->form_selector legend" );
		Utils::fix_fonts_transition( $fields, 'placeholder_text', "$this->form_selector input::placeholder, $this->form_selector select::placeholder, $this->form_selector textarea::placeholder" );
	...
	protected function squad_generate_all_styles( array $attrs ): void {
		 ...
		 * @param FormStyler $module The current FormStyler instance
		 */
