...
class BeforeAfterImageSlider extends Module {
	...
	public function init(): void {
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'before_label_text' => Utils::add_font_field(
				...
				'after_label_text'  => Utils::add_font_field(
					esc_html__( 'Label', 'squad-modules-for-divi' ),
					array(
						'font_size'   => array(
							'default' => '16px',
			...
			'width'          => Utils::selectors_default( $this->main_css_element ),
	...
	public function get_fields(): array {
		...
		$settings_fields = array(
			'image_label__enable'               => Utils::add_yes_no_field(
			...
			'image_label_hover__enable'         => Utils::add_yes_no_field(
			...
			'slide_direction_mode'              => Utils::add_select_box_field(
			...
			'slide_trigger_type'                => Utils::add_select_box_field(
			...
			'slide_control_color'               => Utils::add_color_field(
			...
			'slide_control_start_point'         => Utils::add_range_field(
			...
			'slide_control_shadow__enable'      => Utils::add_yes_no_field(
			...
			'slide_control_circle__enable'      => Utils::add_yes_no_field(
			...
			'slide_control_circle_blur__enable' => Utils::add_yes_no_field(
			...
			'slide_control_smoothing__enable'   => Utils::add_yes_no_field(
			...
			'slide_control_smoothing_amount'    => Utils::add_range_field(
	...
	private function squad_get_image_fields( string $image_type ): array {
		...
		$label_background_fields = $this->squad_utils->add_background_field(
			array(
		...
		$label_associate_fields = array(
			"{$image_type}_label_margin"  => Utils::add_margin_padding_field(
			...
			"{$image_type}_label_padding" => Utils::add_margin_padding_field(
