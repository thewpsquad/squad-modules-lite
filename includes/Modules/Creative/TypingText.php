...
namespace DiviSquad\Modules\Creative;
...
class TypingText extends Module {
	...
	public function init(): void {
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'prefix_text' => Utils::add_font_field(
				...
				'typed_text'  => Utils::add_font_field(
				...
				'suffix_text' => Utils::add_font_field(
	...
	public function get_fields(): array {
		...
		$typing_effects = array(
			'typing_speed'                 => Utils::add_range_field(
			...
			'typing_start_delay'           => Utils::add_range_field(
			...
			'typing_back_speed'            => Utils::add_range_field(
			...
			'typing_back_delay'            => Utils::add_range_field(
			...
			'typing_loop__enable'          => Utils::add_yes_no_field(
			...
			'typing_shuffle__enable'       => Utils::add_yes_no_field(
			...
			'typing_fade_out__enable'      => Utils::add_yes_no_field(
			...
			'typing_fade_out_delay'        => Utils::add_range_field(
			...
			'typing_cursor__enable'        => Utils::add_yes_no_field(
			...
			'custom_cursor_icon__enable'   => Utils::add_yes_no_field(
			...
			'remove_cursor_on_end__enable' => Utils::add_yes_no_field(
		...
		$typed_cursor = array(
			'custom_cursor_icon_color'    => Utils::add_color_field(
			...
			'custom_cursor_icon_size'     => Utils::add_range_field(
			...
			'custom_cursor_icon_text_gap' => Utils::add_range_field(
		...
		$text_associated_fields    = array(
			'horizontal_alignment' => Utils::add_alignment_field(
			...
			'text_gap'             => Utils::add_range_field(
		...
		$prefix_background_fields = $this->squad_utils->add_background_field(
			array(
		...
		$typed_background_fields  = $this->squad_utils->add_background_field(
			array(
		...
		$suffix_background_fields = $this->squad_utils->add_background_field(
			array(
		...
		$prefix_text_clip = Utils::get_text_clip_fields(
			array(
		...
		$typed_text_clip  = Utils::get_text_clip_fields(
			array(
		...
		$suffix_text_clip = Utils::get_text_clip_fields(
			array(
		...
		$display_type_fields = array(
			'prefix_display_type' => Utils::add_select_box_field(
			...
			'typed_display_type'  => Utils::add_select_box_field(
				esc_html__( 'Display Type', 'squad-modules-for-divi' ),
				array(
					'description'    => esc_html__( 'The display CSS property sets whether an element is treated as a block or inline box.', 'squad-modules-for-divi' ),
					'options'        => array(
			...
			'suffix_display_type' => Utils::add_select_box_field(
				esc_html__( 'Display Type', 'squad-modules-for-divi' ),
				array(
					'description'    => esc_html__( 'The display CSS property sets whether an element is treated as a block or inline box.', 'squad-modules-for-divi' ),
					'options'        => array(
		...
		$text_associated_margin_padding_fields = array(
			'prefix_margin'  => Utils::add_margin_padding_field(
			...
			'prefix_padding' => Utils::add_margin_padding_field(
			...
			'typed_margin'   => Utils::add_margin_padding_field(
			...
			'typed_padding'  => Utils::add_margin_padding_field(
			...
			'suffix_margin'  => Utils::add_margin_padding_field(
			...
			'suffix_padding' => Utils::add_margin_padding_field(
	...
	public function get_transition_fields_css_props() {
		...
		Utils::fix_border_transition( $fields, 'wrapper', "$this->main_css_element div .text-elements" );
		Utils::fix_box_shadow_transition( $fields, 'wrapper', "$this->main_css_element div .text-elements" );
		...
		Utils::fix_fonts_transition( $fields, 'prefix_text', "$this->main_css_element div .text-elements .text-item.prefix-element" );
		Utils::fix_border_transition( $fields, 'prefix_element', "$this->main_css_element div .text-elements .text-item.prefix-element" );
		Utils::fix_box_shadow_transition( $fields, 'prefix_element', "$this->main_css_element div .text-elements .text-item.prefix-element" );
		...
		Utils::fix_fonts_transition( $fields, 'typed_text', "$this->main_css_element div .text-elements .text-item.typing-element" );
		Utils::fix_border_transition( $fields, 'typed_element', "$this->main_css_element div .text-elements .text-item.typing-element" );
		Utils::fix_box_shadow_transition( $fields, 'typed_element', "$this->main_css_element div .text-elements .text-item.typing-element" );
		...
		Utils::fix_fonts_transition( $fields, 'suffix_text', "$this->main_css_element div .text-elements .text-item.suffix-element" );
		Utils::fix_border_transition( $fields, 'suffix_element', "$this->main_css_element div .text-elements .text-item.suffix-element" );
		Utils::fix_box_shadow_transition( $fields, 'suffix_element', "$this->main_css_element div .text-elements .text-item.suffix-element" );
	...
	protected function render_prefix_text( array $attrs ): string {
		...
		$this->squad_utils->generate_text_clip_styles(
			array(
				'base_attr_name' => 'prefix',
				'selector'       => "$this->main_css_element div .text-elements .text-item.prefix-element",
				'hover'          => "$this->main_css_element div .text-elements:hover .text-item.prefix-element",
