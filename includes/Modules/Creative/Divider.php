...
class Divider extends Module {
	...
	public function init(): void {
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'divider_icon_text' => Utils::add_font_field(
	...
	public function get_fields(): array {
		$divider_default_fields     = array(
			'divider_type'          => Utils::add_select_box_field(
			...
			'divider_icon_text_tag' => Utils::add_select_box_field(
			...
			'multiple_divider'      => Utils::add_yes_no_field(
			...
			'multiple_divider_no'   => Utils::add_range_field(
			...
			'multiple_divider_gap'  => Utils::add_range_field(
			...
			'divider_color'         => Utils::add_color_field(
		...
		$divider_custom_colors      = array(
			'use_divider_custom_color' => Utils::add_yes_no_field(
		...
		$divider_custom_sizes       = array(
			'divider_custom_size'       => Utils::add_yes_no_field(
			...
			'divider_custom_size_left'  => Utils::add_range_field(
			...
			'divider_custom_size_right' => Utils::add_range_field(
		...
		$icon_image_fields_all = array(
			'divider_icon_type'              => Utils::add_select_box_field(
			...
			'divider_icon_lottie_src_type'   => Utils::add_select_box_field(
		...
		$icon_text_clip = Utils::get_text_clip_fields(
			array(
		...
		$divider_element_fields = array(
			'divider_element_gap'       => Utils::add_range_field(
			...
			'divider_element_placement' => Utils::add_placement_field(
			...
			'divider_element_margin'    => Utils::add_margin_padding_field(
			...
			'divider_element_padding'   => Utils::add_margin_padding_field(
		...
		$icon_image_associated_fields_all = array(
			'divider_icon_color'                  => Utils::add_color_field(
			...
			'divider_image_icon_background_color' => Utils::add_color_field(
			...
			'divider_icon_size'                   => Utils::add_range_field(
			...
			'divider_image_width'                 => Utils::add_range_field(
			...
			'divider_image_height'                => Utils::add_range_field(
			...
			'divider_icon_margin'                 => Utils::add_margin_padding_field(
			...
			'divider_icon_padding'                => Utils::add_margin_padding_field(
		...
		$lottie_animation_fields = array(
			'divider_icon_lottie_trigger_method'  => Utils::add_select_box_field(
			...
			'divider_icon_lottie_mouseout_action' => Utils::add_select_box_field(
			...
			'divider_icon_lottie_click_action'    => Utils::add_select_box_field(
			...
			'divider_icon_lottie_scroll'          => Utils::add_select_box_field(
			...
			'divider_icon_lottie_play_on_hover'   => Utils::add_yes_no_field(
			...
			'divider_icon_lottie_loop'            => Utils::add_yes_no_field(
			...
			'divider_icon_lottie_loop_no_times'   => Utils::add_range_field(
			...
			'divider_icon_lottie_delay'           => Utils::add_range_field(
			...
			'divider_icon_lottie_speed'           => Utils::add_range_field(
			...
			'divider_icon_lottie_mode'            => Utils::add_select_box_field(
			...
			'divider_icon_lottie_direction'       => Utils::add_select_box_field(
			...
			'divider_icon_lottie_renderer'        => Utils::add_select_box_field(
		...
		$lottie_associated_fields = array(
			'divider_icon_lottie_background_color' => Utils::add_color_field(
			...
			'divider_icon_lottie_color'            => Utils::add_color_field(
			...
			'divider_icon_lottie_width'            => Utils::add_range_field(
			...
			'divider_icon_lottie_height'           => Utils::add_range_field(
	...
	public function get_transition_fields_css_props(): array {
		...
		Utils::fix_border_transition( $fields, 'wrapper', "$this->main_css_element div .divider-elements" );
		Utils::fix_box_shadow_transition( $fields, 'wrapper', "$this->main_css_element div .divider-elements" );
