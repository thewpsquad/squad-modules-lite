 ...
 */
class FluentForms extends FormStyler {
	...
	public function init(): void {
		 ...
		 * @since 3.2.0
		 *
		 * @param FluentForms $this The current module instance.
		 */
		...
		$this->icon_path        = HelperUtil::fix_slash( divi_squad()->get_icon_path() . '/fluent-forms.svg' );
	...
	public function render( $attrs, $content, $render_slug ): string {
		try {
			...
			if ( empty( $form_html ) ) {
				 ...
				 * @param array        $attrs     The module attributes.
				 * @param ContactForm7 $this      The current module instance.
				 */
	...
	protected function squad_get_module_stylesheet_selectors( array $attrs ): array {
		 ...
		 * @since 3.2.0
		 *
		 * @param ContactForm7 $this  Current module instance
		...
		$fields = array(
			'form_id'               => Utils::add_select_box_field(
				...
				array(
					...
					'options'          => FormsUtil::get_forms_by( 'fluent_forms' ),
	...
	protected function get_field_selector(): string {
		 ...
		 * @since 3.2.0
		 *
		 * @param Forminator $this      The current module instance.
		 *
	...
	protected function squad_get_font_fields(): array {
		 ...
		 * @since 3.2.0
		 *
		 * @param FluentForms $this        Current module instance.
	...
	public static function squad_form_styler__get_form_html( array $attrs ): string {
		...
		if ( empty( $attrs['form_id'] ) || FormsUtil::DEFAULT_FORM_ID === $attrs['form_id'] || ! function_exists( 'wpFluentForm' ) ) {
			return '';
		}
		...
		if ( empty( $form_id_raw ) ) {
			$collection = FormsUtil::get_forms_by( 'fluent_forms', 'id' );
