...
class NinjaForms extends FormStyler {
	...
	public function init(): void {
		 ...
		 * @since 3.2.0
		 *
		 * @param NinjaForms $module The instance of the NinjaForms class.
		 */
		...
		$this->icon_path        = HelperUtil::fix_slash( divi_squad()->get_icon_path() . '/ninja-forms.svg' );
	...
	public function render( $attrs, $content, $render_slug ): string {
		try {
			 ...
			 * @param NinjaForms $module The Ninja Forms instance.
			 */
			...
			if ( empty( $form_html ) ) {
				 ...
				 * @param array      $attrs     The module attributes.
				 * @param NinjaForms $module    The current module instance.
				 */
		...
		return array(
			'form_id'               => Utils::add_select_box_field(
				...
				array(
					...
					'options'          => FormsUtil::get_forms_by( 'ninja_forms' ),
	...
	protected function squad_get_checkbox_radio_fields(): array {
		$parent_fields = parent::squad_get_checkbox_radio_fields();

		$checkbox_radio_border_colors = Utils::add_color_field(
	...
	protected function squad_get_font_fields(): array {
		$font_fields = array(
			...
			'validation'        => Utils::add_font_field(
		 ...
		 * @param NinjaForms $module      Current module instance
		 */
	...
	public static function squad_form_styler__get_form_html( array $attrs ): string {
		...
		if ( empty( $attrs['form_id'] ) || FormsUtil::DEFAULT_FORM_ID === $attrs['form_id'] || ! function_exists( '\Ninja_Forms' ) ) {
			return '';
		}
		...
		if ( empty( $form_id_raw ) ) {
			$collection = FormsUtil::get_forms_by( 'ninja_forms', 'id' );
		...
		$i18n = class_exists( Ninja_Forms::class ) ? Ninja_Forms::config( 'i18nFrontEnd' ) : array();
