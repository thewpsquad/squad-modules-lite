 ...
 * @extends    FormStyler
 */
class GravityForms extends FormStyler {
	...
	public function init(): void {
		 ...
		 * @since 3.2.0
		 *
		 * @param GravityForms $module The current module instance.
		 */
		...
		$this->icon_path        = HelperUtil::fix_slash( divi_squad()->get_icon_path() . '/gravity-forms.svg' );
		 ...
		 * @since  3.2.0
		 *
		 * @param array        $selectors The default array of CSS selectors from squad_get_css_selectors().
		 * @param GravityForms $module    The GravityForms instance.
		 *
	...
	public function render( $attrs, $content, $render_slug ): string {
		try {
			 ...
			 * @param GravityForms $module The Gravity Forms instance.
			 */
		...
		return array(
			'form_id'                  => Utils::add_select_box_field(
				...
				array(
					...
					'options'          => FormsUtil::get_forms_by( 'gravity_forms' ),
	...
	protected function squad_get_font_fields(): array {
		$font_fields = array(
			'form_title'         => Utils::add_font_field(
			...
			'form_description'   => Utils::add_font_field(
			...
			'field_label'        => Utils::add_font_field(
			...
			'field_input'        => Utils::add_font_field(
			...
			'field_description'  => Utils::add_font_field(
			...
			'field_placeholder'  => Utils::add_font_field(
			...
			'form_button'        => Utils::add_font_field(
			...
			'validation_message' => Utils::add_font_field(
				esc_html__( 'Validation Message', 'squad-modules-for-divi' ),
				array(
					'css'         => array(
			...
			'success_message'    => Utils::add_font_field(
			...
			'error_message'      => Utils::add_font_field(
		 ...
		 * @param GravityForms $module        Current module instance
		 */
	...
	protected function squad_get_border_fields(): array {
		$border_fields = array(
			...
			'form_title'         => Utils::add_border_field(
				esc_html__( 'Title', 'squad-modules-for-divi' ),
				array(
					'css'         => array(
						'main'      => array(
			...
			'form_description'   => Utils::add_border_field(
				esc_html__( 'Description', 'squad-modules-for-divi' ),
				array(
					'css'         => array(
						'main'      => array(
			...
			'message_validation' => Utils::add_border_field(
				esc_html__( 'Validation Message', 'squad-modules-for-divi' ),
				array(
					'css'         => array(
						'main'      => array(
	...
	protected function squad_get_box_shadow_fields(): array {
		$box_shadow_fields = array(
			...
			'form_title'         => Utils::add_box_shadow_field(
			...
			'form_description'   => Utils::add_box_shadow_field(
			...
			'message_validation' => Utils::add_box_shadow_field(
	...
	public function squad_add_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'field_label_text', $this->squad_get_css_selector_string( 'typography.labels' ) );
		Utils::fix_fonts_transition( $fields, 'field_sub_label_text', $this->squad_get_css_selector_string( 'typography.sub_labels' ) );
		Utils::fix_fonts_transition( $fields, 'field_input_text', $this->squad_get_css_selector_string( 'field_elements.input' ) );
		Utils::fix_fonts_transition( $fields, 'field_description_text', $this->squad_get_css_selector_string( 'description.field' ) );
		Utils::fix_fonts_transition( $fields, 'field_placeholder_text', $this->squad_get_css_selector_string( 'typography.placeholders' ) );
		Utils::fix_fonts_transition( $fields, 'section_title_text', $this->squad_get_css_selector_string( 'sections.title' ) );
		Utils::fix_fonts_transition( $fields, 'list_header_text', $this->squad_get_css_selector_string( 'list_fields.header' ) );
		Utils::fix_fonts_transition( $fields, 'consent_description_text', $this->squad_get_css_selector_string( 'consent_field.wrapper' ) );
		Utils::fix_fonts_transition( $fields, 'required_wrapper', $this->squad_get_css_selector_string( 'required_field.wrapper' ) );
		Utils::fix_fonts_transition( $fields, 'required_text', $this->squad_get_css_selector_string( 'required_field.text' ) );
		Utils::fix_fonts_transition( $fields, 'required_input', $this->squad_get_css_selector_string( 'required_field.input' ) );
		Utils::fix_fonts_transition( $fields, 'required_error', $this->squad_get_css_selector_string( 'required_field.error' ) );
		Utils::fix_fonts_transition( $fields, 'page_steps_text', $this->squad_get_css_selector_string( 'page_steps.step' ) );
	...
	protected function squad_add_form_title_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'form_title_text', $this->squad_get_css_selector_string( 'typography.title' ) );
		Utils::fix_border_transition( $fields, 'form_title', $this->squad_get_css_selector_string( 'typography.title' ) );
		Utils::fix_box_shadow_transition( $fields, 'form_title', $this->squad_get_css_selector_string( 'typography.title' ) );
	}
	...
	protected function squad_add_form_description_transition_fields( array &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'form_description_text', $this->squad_get_css_selector_string( 'typography.description' ) );
		Utils::fix_border_transition( $fields, 'form_description', $this->squad_get_css_selector_string( 'typography.description' ) );
		Utils::fix_box_shadow_transition( $fields, 'form_description', $this->squad_get_css_selector_string( 'typography.description' ) );
	}
	...
	protected function squad_add_validation_message_transition_fields( &$fields ): void {
		...
		Utils::fix_fonts_transition( $fields, 'message_validation_text', $this->squad_get_css_selector_string( 'messages.validation' ) );
		Utils::fix_border_transition( $fields, 'message_validation', $this->squad_get_css_selector_string( 'messages.validation' ) );
		Utils::fix_box_shadow_transition( $fields, 'message_validation', $this->squad_get_css_selector_string( 'messages.validation' ) );
	}
	...
	public static function squad_form_styler__get_form_html( array $attrs ): string {
		...
		if ( empty( $attrs['form_id'] ) || FormsUtil::DEFAULT_FORM_ID === $attrs['form_id'] || ! function_exists( '\gravity_form' ) ) {
			return '';
		}
		...
		if ( empty( $form_id_raw ) ) {
			$collection = FormsUtil::get_forms_by( 'gravity_forms', 'id' );
		...
		$html = \gravity_form( $form_id_raw, $form_title, $form_description, false, null, $form_ajax, '', false );
