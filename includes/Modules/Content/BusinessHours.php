...
namespace DiviSquad\Modules\Content;
...
class BusinessHours extends Module {
	...
	public function get_fields(): array {
		$text_fields      = array(
			...
			'title_tag' => Utils::add_select_box_field(
		...
		$general_settings = array(
			'title__enable'    => Utils::add_yes_no_field(
			...
			'day_elements_gap' => Utils::add_range_field(
			...
			'wrapper_gap'      => Utils::add_range_field(
		...
		$wrapper_associated_fields = array(
			'day_text_width'               => Utils::add_range_field(
			...
			'time_text_width'              => Utils::add_range_field(
			...
			'day_wrapper_text_orientation' => Utils::add_alignment_field(
			...
			'day_wrapper_margin'           => Utils::add_margin_padding_field(
			...
			'day_wrapper_padding'          => Utils::add_margin_padding_field(
	...
	public function get_transition_fields_css_props(): array {
		...
		Utils::fix_border_transition( $fields, 'item_wrapper', "$this->main_css_element .day-elements" );
		Utils::fix_box_shadow_transition( $fields, 'item_wrapper', "$this->main_css_element .day-elements" );
		...
		Utils::fix_fonts_transition( $fields, 'title_text', "$this->main_css_element .squad-bh-elements .bh-element.bh-title-wrapper .bh-title-text" );
		Utils::fix_border_transition( $fields, 'title_element', "$this->main_css_element .squad-bh-elements .bh-element.bh-title-wrapper" );
		Utils::fix_box_shadow_transition( $fields, 'title_element', "$this->main_css_element .squad-bh-elements .bh-element.bh-title-wrapper" );
