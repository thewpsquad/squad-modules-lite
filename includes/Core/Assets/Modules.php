...
final class Modules {
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	public function enqueue_builder( Assets $assets ): void {
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	private function register_vendor_scripts( Assets $assets ): void {
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	private function register_magnific_popup( Assets $assets ): void {
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	private function register_module_scripts( Assets $assets ): void {
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	public function register_module_styles( Assets $assets ): void {
		// Register module-specific styles
	}
	 ...
	 * @param Assets $assets Assets manager instance.
	 */
	private function enqueue_common_styles( Assets $assets ): void {
	...
	private function get_module_assets_configs(): array {
		$configs = array(
			...
			'gallery'         => array(
				'deps' => array( 'squad-vendor-light-gallery', 'squad-vendor-masonry' ),
			),
