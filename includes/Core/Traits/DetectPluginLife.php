...
trait DetectPluginLife {
	...
	public function is_pro_activated(): bool {
		if ( null === self::$cached_pro_installed ) {
			 ...
			 * @param string $basename  The premium plugin basename
			 */
			self::$cached_pro_installed = apply_filters( 'divi_squad_is_pro_activated', $is_active, $this->get_pro_basename() );
		}
	...
	public function is_dev(): bool {
		$is_dev = file_exists( $this->get_path( '/node_modules' ) ) && file_exists( $this->get_path( '/tests' ) );
