...
/**
 * Team Member Module (Divi 5 / Block API).
 *
...
/**
 * Team Member parent module class.
 *
 * @since 4.2.0
 */
class Team_Member extends Module {
	...
	public static function module_classnames( array $args ): void {
		$args['classnamesInstance']->add( 'disq_team_member' );
	...
	/**
	 * Render the Team Member module on the frontend.
	 *
		...
		try {
			if ( '' === trim( $child_modules_content ) ) {
				return sprintf(
					...
					esc_html__( 'Add at least one Team Member.', 'squad-modules-for-divi' )
				);
			}
			...
			divi_squad()->log_error( $e, 'Failed to render Divi 5 Team Member module' );
