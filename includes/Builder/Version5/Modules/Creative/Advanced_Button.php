...
class Advanced_Button extends Module {
     ...
     *
     * Accepts a positive number followed by a valid CSS unit. Returns '' if the
     * value does not match — making the declaration a no-op rather than injecting
     * unsafe content into the stylesheet.
     *
     * @since 4.1.0
     *
