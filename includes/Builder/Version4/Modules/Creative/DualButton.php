...
class DualButton extends Module {
	...
	public function init(): void {
		...
		$this->icon_path = divi_squad()->get_icon_path( 'dual-button.svg' );
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'left_button_text'  => divi_squad()->d4_module_helper->add_font_field(
				...
				'right_button_text' => divi_squad()->d4_module_helper->add_font_field(
				...
				'separator_text'    => divi_squad()->d4_module_helper->add_font_field(
	...
	public function get_fields(): array {
		...
		$left_button  = $this->squad_utils->field_definitions->get_button_fields(
			array(
		...
		$right_button = $this->squad_utils->field_definitions->get_button_fields(
			array(
		...
		$separator = array(
			...
			'separator_icon__enable' => divi_squad()->d4_module_helper->add_yes_no_field(
			...
			'separator_icon_type'    => divi_squad()->d4_module_helper->add_select_box_field(
		...
		$separator_background_fields = $this->squad_utils->field_definitions->add_background_field(
			array(
		...
		$separator_associated_fields = array(
			'separator_icon_color'     => divi_squad()->d4_module_helper->add_color_field(
			...
			'separator_icon_size'      => divi_squad()->d4_module_helper->add_range_field(
			...
			'separator_image_width'    => divi_squad()->d4_module_helper->add_range_field(
			...
			'separator_image_height'   => divi_squad()->d4_module_helper->add_range_field(
			...
			'separator_custom_width'   => divi_squad()->d4_module_helper->add_yes_no_field(
			...
			'separator_width'          => divi_squad()->d4_module_helper->add_range_field(
			...
			'separator_item_alignment' => divi_squad()->d4_module_helper->add_alignment_field(
			...
			'separator_icon_margin'    => divi_squad()->d4_module_helper->add_margin_padding_field(
			...
			'separator_margin'         => divi_squad()->d4_module_helper->add_margin_padding_field(
			...
			'separator_padding'        => divi_squad()->d4_module_helper->add_margin_padding_field(
		...
		$wrapper_fields            = array(
			'wrapper_horizontal_alignment' => divi_squad()->d4_module_helper->add_alignment_field(
			...
			'wrapper_elements_layout'      => divi_squad()->d4_module_helper->add_select_box_field(
			...
			'buttons_horizontal_alignment' => divi_squad()->d4_module_helper->add_alignment_field(
			...
			'wrapper_elements_gap'         => divi_squad()->d4_module_helper->add_range_field(
	...
	public function get_transition_fields_css_props() {
		...
		divi_squad()->d4_module_helper->fix_border_transition( $fields, 'wrapper', "$this->main_css_element div .elements" );
		divi_squad()->d4_module_helper->fix_box_shadow_transition( $fields, 'wrapper', "$this->main_css_element div .elements" );
		...
		divi_squad()->d4_module_helper->fix_fonts_transition( $fields, 'left_button_text', "$this->main_css_element div .elements .squad-button.left_button" );
		divi_squad()->d4_module_helper->fix_border_transition( $fields, 'left_button_element', "$this->main_css_element div .elements .squad-button.left_button" );
		divi_squad()->d4_module_helper->fix_box_shadow_transition( $fields, 'left_button_element', "$this->main_css_element div .elements .squad-button.left_button" );
		...
		divi_squad()->d4_module_helper->fix_fonts_transition( $fields, 'right_button_text', "$this->main_css_element div .elements .squad-button.right_button" );
		divi_squad()->d4_module_helper->fix_border_transition( $fields, 'right_button_element', "$this->main_css_element div .elements .squad-button.right_button" );
		divi_squad()->d4_module_helper->fix_box_shadow_transition( $fields, 'right_button_element', "$this->main_css_element div .elements .squad-button.right_button" );
		...
		divi_squad()->d4_module_helper->fix_border_transition( $fields, 'separator_element', "$this->main_css_element div .elements .squad-separator" );
		divi_squad()->d4_module_helper->fix_box_shadow_transition( $fields, 'separator_element', "$this->main_css_element div .elements .squad-separator" );
	 ...
	 * @return string
	 */
	private function squad_render_element_text( array $attrs, string $element ): string {
	 ...
	 * @return string
	 */
	private function squad_render_element_separator( array $attrs ): string {
		$multi_view     = et_pb_multi_view_options( $this );
