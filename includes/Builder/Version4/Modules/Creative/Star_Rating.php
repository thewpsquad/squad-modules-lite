...
class Star_Rating extends Module {
	...
	public function init(): void {
		...
		$this->icon_path = divi_squad()->get_icon_path( 'star-rating.svg' );
		...
		$this->settings_modal_toggles = array(
			...
			'advanced' => array(
				'toggles' => array(
					...
					'rating_number' => esc_html__( 'Rating Number', 'squad-modules-for-divi' ),
				),
			),
		);
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'header'        => divi_squad()->d4_module_helper->add_font_field(
				...
				'rating_number' => divi_squad()->d4_module_helper->add_font_field(
	...
	public function get_fields(): array {
		// All rating fields.
		$rating_fields = array(
			'rating_scale'   => divi_squad()->d4_module_helper->add_select_box_field(
			...
			'rating_upto_5'  => divi_squad()->d4_module_helper->add_range_field(
			...
			'rating_upto_10' => divi_squad()->d4_module_helper->add_range_field(
				esc_html__( 'Rating', 'squad-modules-for-divi' ),
				array(
		...
		$rating_title_fields = array(
			...
			'stars_display_type'     => divi_squad()->d4_module_helper->add_select_box_field(
			...
			'title_inline_position'  => divi_squad()->d4_module_helper->add_select_box_field(
			...
			'title_stacked_position' => divi_squad()->d4_module_helper->add_select_box_field(
			...
			'title_gap'              => divi_squad()->d4_module_helper->add_range_field(
		...
		$stars_associated_fields = array(
			'star_alignment' => divi_squad()->d4_module_helper->add_alignment_field(
			...
			'stars_size'     => divi_squad()->d4_module_helper->add_range_field(
			...
			'stars_gap'      => divi_squad()->d4_module_helper->add_range_field(
			...
			'stars_color'    => divi_squad()->d4_module_helper->add_color_field(
		...
		$rating_control_fields = array(
			'show_number' => divi_squad()->d4_module_helper->add_yes_no_field(
		...
		$schema_fields = array(
			'stars_schema_markup'        => divi_squad()->d4_module_helper->add_yes_no_field(
